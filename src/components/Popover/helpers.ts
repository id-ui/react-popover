...
const isPlainObject = (value: unknown): value is PlainObject => typeof value === 'object' && Object.prototype.toString.call(value) == '[object Object]'
...
export const upperFirst = (value: string) => value.replace(/./, letter => letter.toUpperCase())